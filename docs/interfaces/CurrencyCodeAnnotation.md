[@affinda/affinda](../README.md) / [Exports](../modules.md) / CurrencyCodeAnnotation

# Interface: CurrencyCodeAnnotation
...
- [classificationConfidence](CurrencyCodeAnnotation.md#classificationconfidence)
- [confidence](CurrencyCodeAnnotation.md#confidence)
- [contentType](CurrencyCodeAnnotation.md#contenttype)
- [dataPoint](CurrencyCodeAnnotation.md#datapoint)
- [document](CurrencyCodeAnnotation.md#document)
- [id](CurrencyCodeAnnotation.md#id)
- [isAutoVerified](CurrencyCodeAnnotation.md#isautoverified)
- [isClientVerified](CurrencyCodeAnnotation.md#isclientverified)
- [isVerified](CurrencyCodeAnnotation.md#isverified)
- [pageIndex](CurrencyCodeAnnotation.md#pageindex)
- [parent](CurrencyCodeAnnotation.md#parent)
- [parsed](CurrencyCodeAnnotation.md#parsed)
- [raw](CurrencyCodeAnnotation.md#raw)
- [rectangle](CurrencyCodeAnnotation.md#rectangle)
- [rectangles](CurrencyCodeAnnotation.md#rectangles)
- [textExtractionConfidence](CurrencyCodeAnnotation.md#textextractionconfidence)
...
• `Optional` **parsed**: [`DataPointChoice`](DataPointChoice.md)
