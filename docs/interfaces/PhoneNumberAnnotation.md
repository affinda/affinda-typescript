[@affinda/affinda](../README.md) / [Exports](../modules.md) / PhoneNumberAnnotation
...
- [classificationConfidence](PhoneNumberAnnotation.md#classificationconfidence)
- [confidence](PhoneNumberAnnotation.md#confidence)
- [contentType](PhoneNumberAnnotation.md#contenttype)
- [dataPoint](PhoneNumberAnnotation.md#datapoint)
- [document](PhoneNumberAnnotation.md#document)
- [id](PhoneNumberAnnotation.md#id)
- [isAutoVerified](PhoneNumberAnnotation.md#isautoverified)
- [isClientVerified](PhoneNumberAnnotation.md#isclientverified)
- [isVerified](PhoneNumberAnnotation.md#isverified)
- [pageIndex](PhoneNumberAnnotation.md#pageindex)
- [parent](PhoneNumberAnnotation.md#parent)
- [parsed](PhoneNumberAnnotation.md#parsed)
- [raw](PhoneNumberAnnotation.md#raw)
- [rectangle](PhoneNumberAnnotation.md#rectangle)
- [rectangles](PhoneNumberAnnotation.md#rectangles)
- [textExtractionConfidence](PhoneNumberAnnotation.md#textextractionconfidence)
...
• `Optional` **parsed**: [`PhoneNumberAnnotationParsed`](PhoneNumberAnnotationParsed.md)
